...
const TOOL_LABELS = {
  ...
  frame_gallery: "Frames to PDF",
  "frames-to-pdf": "Frames to PDF",
  frames_to_pdf: "Frames to PDF",
...
const ACTION_METADATA = {
  ...
  "toggle-frame-gallery": {
    label: "Toggle Frames to PDF",
    description: "Open/close Frames to PDF panel.",
    category: "Navigation",
    signal: "high",
  },
  "toggle-import-tool": {
  ...
  "get-all-frames": {
    label: "Load Frames to PDF",
    description: "Refresh the frame list for the Frames to PDF tool.",
    category: "Frame Workflow",
    signal: "low",
    passive: true,
  },
  "export-frames-with-dpi": {
    label: "Preview Frames at DPI",
    description: "Refresh frame previews at the requested DPI before export.",
    category: "Export",
    signal: "high",
  },
  ...
  "toggle-html-to-design": {
    label: "Toggle HTML to Design",
    description: "Open/close HTML to Design panel.",
    category: "Navigation",
    signal: "high",
  },
  "import-html-design-layers": {
    label: "Import HTML Design Layers",
    description: "Create Figma layers from imported HTML design data.",
    category: "Import",
    signal: "high",
  },
  "toggle-comment-summarizer": {
    label: "Toggle Comment Summarizer",
    description: "Open/close Comment Summarizer panel.",
    category: "Navigation",
    signal: "high",
  },
  "open-comment-summary": {
    label: "Open Comment Summary",
    description: "Open a generated comment summary view.",
    category: "Comment Summarizer",
    signal: "high",
  },
  "load-comments": {
    label: "Load Comments",
    description: "Load source comments before summarization.",
    category: "Comment Summarizer",
    signal: "low",
    passive: true,
  },
  "run-summarization": {
    ...
    description: "Generate a fresh comment summary.",
    category: "Comment Summarizer",
    signal: "high",
  },
  "start-new-summary": {
    label: "Start New Summary",
    description: "Reset the summarizer for a new run.",
    category: "Comment Summarizer",
    signal: "medium",
  },
  "show-comment-summarizer-tutorial": {
    label: "Show Comment Summarizer Tutorial",
    description: "Show the Comment Summarizer onboarding flow.",
    category: "Comment Summarizer",
    signal: "low",
  },
  "lg-refresh": {
